...
\begin{document}
	...
	\begin{description} 
		...
		\item[\texttt{STT\_$\overline{\texttt{OE}}$}] -- Włącza wyjście danych z \texttt{STATE TRANSLATOR} na magistralę \texttt{Q\textsubscript{0...7}}; aktywny dla niskiego poziomu;
		...
		\item[\texttt{QR\_$\overline{\texttt{OE}}$}] -- Włącza wyjście danych z \texttt{STATE REGISTER} na magistralę \texttt{D\textsubscript{0...7}}; aktywny dla niskiego poziomu;
		...
		\item[$\overline{\texttt{SYMB\_BUF}}$] -- Włącza przepływ danych z \texttt{TAPE} lub \texttt{SYMBOL TRANSLATOR} na magistralę \texttt{D\textsubscript{0...7}}; aktywny dla niskiego poziomu;
	...
	Programowanie maszyny odbywa się za pomocą interfejsu zewnętrznego. Dzięki odpowiedniemu wykorzystaniu udostępnionych sygnałów
