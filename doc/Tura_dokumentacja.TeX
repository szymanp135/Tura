...
\begin{document}
	...
	Po osiągnięciu przez maszynę stanu akceptującego zatrzymującego jej działanie program został wykonany. W celu odczytu wyniku pracy należy wpierw określić sposób jego zapisu. Jednym z naturalnych sposobów jest umieszczenie wyniku na początku taśmy i pozostawienie głowicy nad pierwszym symbolem taśmy. Ten podrozdział opisze jak odczytać wynik w przypadku jego zapisu tym właśnie sposobem.
